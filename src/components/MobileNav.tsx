  ...
  return (
    <div className="md:hidden">
      ...
      <nav
        ...
        className="absolute inset-x-0 top-full border-y border-white/10 bg-[#0b0d0c] px-4 py-4 shadow-2xl"
      >
        <div className="mx-auto flex max-w-6xl flex-col gap-1">
          {links.map((link) => (
            <Link
              ...
              className="rounded-md px-4 py-4 text-base font-semibold text-[#f1ebe0] hover:bg-white/[0.06]"
            >
              {link.label}
            </Link>
          ))}
